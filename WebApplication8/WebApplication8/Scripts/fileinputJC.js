...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        removeClass: 'btnJC btnJC-xs btnJC-default',
        removeTitle: 'Remove file',
        uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
        uploadClass: 'btnJC btnJC-xs btnJC-default',
    ...
    tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
        '   {uploadIcon}\n</button>\n';
    tZoom = '<button type="button" class="btnJC btnJC-default btnJC-xs btnJC-block" title="{zoomTitle}: {caption}" onclick="{dialog}">\n' +
        '   {zoomInd}\n' +
        '</button>\n';
    ...
    FileInput.prototype = {
        ...
        disable: function () {
            ...
            self.$container.find(".btnJC-file, .fileinput-remove, .fileinput-upload, .file-preview-frame button").attr(
                "disabled",
                true);
            self.initDragDrop();
        },
        enable: function () {
            ...
            self.$container.find(
                ".btnJC-file, .fileinput-remove, .fileinput-upload, .file-preview-frame button").removeAttr("disabled");
            self.initDragDrop();
        },
        ...
        initBrowse: function ($container) {
            var self = this;
            self.$btnFile = $container.find('.btnJC-file');
        ...
        renderButton: function (type) {
            ...
            css += type === 'browse' ? ' btnJC-file' : ' fileinput-' + type + ' fileinput-' + type + '-button';
            if (!isEmpty(label)) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btnJC btnJC-primaryJC',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'btnJC btnJC-default',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btnJC btnJC-default',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
        uploadClass: 'btnJC btnJC-default',
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        minImageWidth: null,
